...
namespace ecstsy\AetherisRecode\blocks;
...
class CustomSpawner extends MonsterSpawner
{
    ...
    public function getSilkTouchDrops(Item $item) : array{
        $id = ($tile = $this->position->getWorld()->getTile($this->position)) instanceof SpawnerTile ? $tile->getLegacyEntityId() : $this->legacyEntityId;
        return [StringToItemParser::getInstance()->parse('52:'. $id) ?? SpawnerItem::MONSTER_SPAWNER()];
    }
}