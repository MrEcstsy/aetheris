...
final class SpawnerItem {

    use CloningRegistryTrait;

    /**
     * @method static CustomSpawner MONSTER_SPAWNER()
     */
    ...
    {
        self::register('monster_spawner', new CustomSpawner(new BlockIdentifier(self::$spawnerRuntimeId = BlockTypeIds::MONSTER_SPAWNER, SpawnerTile::class), 'SB Monster Spawner', new BlockTypeInfo(new BlockBreakInfo(5.0, BlockToolType::PICKAXE, ToolTier::WOOD()->getHarvestLevel()))));
    }
    ...
    public static function fromString(string $name): SpawnerItem {
        $result = self::_registryFromString($name);
        assert($result instanceof SpawnerItem);
        return $result;
    }
