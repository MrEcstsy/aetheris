...
use ecstsy\AetherisRecode\commands\subcommands\enchants\EnchantSubCommand;
use ecstsy\AetherisRecode\commands\subcommands\enchants\GiveBookSubCommand;
use ecstsy\AetherisRecode\commands\subcommands\enchants\GiveItemSubCommand;
use ecstsy\AetherisRecode\commands\subcommands\enchants\GiveRCBookSubCommand;
use ecstsy\AetherisRecode\commands\subcommands\enchants\InfoSubCommand;
use ecstsy\AetherisRecode\commands\subcommands\enchants\ListSubCommand;
use ecstsy\AetherisRecode\commands\subcommands\enchants\UnenchantSubCommand;
use ecstsy\AetherisRecode\Loader;
use pocketmine\command\CommandSender;
use pocketmine\player\Player;
use pocketmine\utils\TextFormat as C;

final class EnchantmentsCommand extends BaseCommand {
    ...
    public function onRun(CommandSender $sender, string $aliasUsed, array $args): void {
        if (!$sender instanceof Player) {
            $sender->sendMessage('AetherisEnchantment Commands MV(minified version for console)');
        ...
        $header = C::YELLOW . "[<]" . C::DARK_GRAY . " +-----< " . C::GOLD . "AetherisEnchantments " . C::WHITE . "(Page $page) " . C::DARK_GRAY . ">-----+" . C::YELLOW . " [>]";
        $footer = C::YELLOW . "[<]" . C::DARK_GRAY . " +-----< " . C::GOLD . "AetherisEnchantments " . C::WHITE . "(Page $page) " . C::DARK_GRAY . ">-----+" . C::YELLOW . " [>]";
    ...
    public function getUsage(): string {
        return C::colorize("&cIncorrect command usage! Type '/ae' for the correct usage.");
    }
